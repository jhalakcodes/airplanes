...
function loadModel() 
{
	...
	function onModelLoaded(obj) {
		...
		const scene = new Scene(object); // Pass the 'object' to the Scene constructor
		scene.render();
	...
	loader.load('/Users/jhalakchahar/Desktop/airplanes/src/Airplane_v1_L1.123c4a6fedec-1680-4a36-a228-b0d440a4f280/11803_Airplane_v1_l1.obj', function (obj) {
		object = obj;
		scene.add(object);
